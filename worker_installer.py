...
def generate_worker_link(worker_name, subdomain):
    ...
    return f"https://{worker_name}.{subdomain}.workers.dev/panel"
...
def main():
    ...
    while True:
        ...
        print(RED + "Forked by TELEGRAM and Github: arshaicomplus" + RESET)
        print(BLUE + "main Creator:" + RESET)
        ...
        if action == '1':
            ...
            create_kv=input_p('Do you want to create a KV namespace? : ',{"1" : "Yes", "2" : "No"})
